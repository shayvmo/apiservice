...
use App\JsonRpc\Interfaces\RmbServiceInterface;
use Hyperf\RpcServer\Annotation\RpcService;


/**
 * @RpcService(name="RmbService", protocol="jsonrpc-http", server="jsonrpc-http")
 */
class RmbService implements RmbServiceInterface
{
    /**
     * @var array
     */
    ...
    public function convert($amount): array
    {
        ...
        $result = ($this->usePrefix ? $this->prefix : '') . $integerResult . $decimalResult;

        return compact('amount', 'result');
    }
